...
public class Crop {
    ...
    public static final int REQUEST_REFRESH = 9163;
    ...
    public static Rect getRect(Intent result) {
        int right = result.getIntExtra(Extra.RIGHT, 0);
        int left = result.getIntExtra(Extra.LEFT, 0);
        int top = result.getIntExtra(Extra.TOP, 0);
        int bottom = result.getIntExtra(Extra.BOTTOM, 0);
